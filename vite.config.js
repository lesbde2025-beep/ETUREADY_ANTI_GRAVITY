  ...
  build: {
    rollupOptions: {
      input: {
        ...
        passEtuReady: resolve(__dirname, 'pass-etuready.html'),
        ...
        personnelAdmin: resolve(__dirname, 'personnel-administratif.html'),
        etuElles: resolve(__dirname, 'etu-elles.html'),
        tournois: resolve(__dirname, 'tournois.html'),
        classementEcoles: resolve(__dirname, 'classement-ecoles.html'),
